...
- [x] **Auto-Success Detection** <!-- id: 60 -->
    - [x] Refactor `guided-module-experience.tsx` with 4-tier fallback logic
    - [x] Refactor `training-content.tsx` with 4-tier fallback logic
...
- [x] **Phase 10: Multi-tenant SaaS Evolution** <!-- id: phase_10 -->
    - [x] **White-Label Engine**: Dynamic variable injection for Vapi/AI <!-- id: whitelabel -->
    - [x] **Usage Analytics**: Track token usage and costs per company <!-- id: usage_tracking -->
    - [x] **Billing & Plans**: Stripe integration with tiered limits <!-- id: billing -->
    - [x] **Live Leaderboard Wiring**: Connect Standings UI to real production data <!-- id: leaderboard_wiring -->
    - [x] **Tenant Isolation**: Ensure cross-company data security <!-- id: isolation -->

- [x] **Phase 11: Manager Coaching Suite (7B)** <!-- id: phase_11 -->
    - [x] **Rep Drill-Down**: Manager view of individual rep simulation history <!-- id: drilldown -->
    - [x] **Simulation Playback**: Review transcripts and AI scores <!-- id: playback -->
    - [x] **Manual Feedback**: Managers can leave comments/coaching on sims <!-- id: coaching -->
    - [x] **Coaching Profile API**: GET /api/v1/reps/{user_id}/coaching-profile <!-- id: coaching_api -->
    - [x] **Coaching Notes Persistence**: POST/GET notes per rep <!-- id: notes_api -->
