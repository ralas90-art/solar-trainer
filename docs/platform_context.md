# Sales Training Platform Context

Last updated: March 10, 2026

## Purpose
This file is the canonical architecture and product-state reference for the active sales training platform inside this repository.
...
## Core Learning Loop
The primary experience now follows this loop:
