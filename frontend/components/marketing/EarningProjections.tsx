        ...
        <section className="px-6 lg:px-20 py-24">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-slate-500 font-body">Industry-standard performance milestones for certified {WHITE_LABEL.companyName} consultants.</p>
                </div>
                ...
                <div className="text-center">
                    <Link href="/signup">
                        <Button className="btn-primary h-16 px-12 text-xl italic font-black uppercase tracking-widest leading-none">
                            Begin Your Journey
                        </Button>
                    </Link>
                </div>
