        ...
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <h1 className="text-6xl md:text-8xl font-black leading-[0.95] tracking-tight text-white mb-8 max-w-5xl mx-auto italic font-display">
                    ...
                    <span className="text-[var(--brand-primary)]">{WHITE_LABEL.industry} Mastery.</span>
                </h1>
                ...
                <p className="text-xl lg:text-2xl text-slate-400 max-w-3xl mx-auto mb-12 leading-relaxed font-light font-body">
                    ...
                    Transform from a salesperson into a {WHITE_LABEL.industry} Consultant in one week.
                </p>
                ...
                <div className="flex flex-wrap gap-6 justify-center">
                    ...
                    <Link href="/curriculum-preview">
                        <Button 
                            size="lg" 
                            className="btn-outline-solar h-16 px-10 text-xl flex items-center gap-3"
                        >
                            View Curriculum
                        </Button>
                    </Link>
                ...
                <div className="mt-24 pt-10 border-t border-white/5">
                    <p className="text-slate-500 text-[10px] font-black uppercase tracking-[0.3em] mb-8">Trusted by 500+ {WHITE_LABEL.industry} Organizations Worldwide</p>
