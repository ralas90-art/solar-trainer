  ...
  return (
    <WidgetCard className={cn(track.status === "certified" ? "brand-glow" : "")}>
      ...
      <div className="mt-4 h-2 overflow-hidden rounded-full bg-white/5">
        <div className="brand-progress h-full" style={{ width: `${track.progress}%` }} />
      </div>
  ...
  return (
    <WidgetCard className="overflow-hidden">
      ...
      <div className="rounded-2xl border border-[#FF5722]/25 bg-[linear-gradient(140deg,rgba(255,87,34,0.14),rgba(255,179,0,0.1))] p-4">
        ...
        <p className="mt-1 text-sm text-[#CBD5E1]">Issued by {WHITE_LABEL.companyName} Training Authority</p>
...
export function CertificationGamification({
  ...
  return (
    <WidgetCard>
      ...
      <div className="mt-4 h-2 overflow-hidden rounded-full bg-white/5">
        <div className="brand-progress h-full" style={{ width: `${levelProgress}%` }} />
      </div>
