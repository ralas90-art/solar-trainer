...
export function AuthForm({ onLogin }: { onLogin: (user: any) => void }) {
    ...
    const handleSubmit = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            onLogin({
                id: data.username, 
                email: data.username + "@internal.com", // Fallback email
                role: "rep",
                companyId: "internal",
                planTier: "enterprise", // Default for internal UI
                tenant: { id: "1", name: WHITE_LABEL.companyName, allowed_states: [selectedState, "CA", "NY"], brand_color: "bg-cyan-500" }
            })
        } catch (err: any) {
            ...
            <div className="relative w-full max-w-md mx-4">
                ...
                <div className="relative glass-circuit rounded-2xl p-8 hud-border">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="font-display text-3xl font-black tracking-tight text-white uppercase italic">
                    ...
                    <p className="mt-6 text-center font-hud text-xs" style={{ color: '#94A3B8', letterSpacing: '0.08em' }}>
                        © 2025 {WHITE_LABEL.companyName} · 7-Day Solar Sales Accelerator
                    </p>
                </div>
            </div>
        </div>
