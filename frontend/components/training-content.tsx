        ...
        <div className="min-h-screen pb-20">
                ...
                {(() => {
                    ...
                    if (WHITE_LABEL.presentationMode === "google_slides") {
                        const embedUrl = (() => {
                            ...
                            if (locale === "es") {
                                // 1. ES Specific
                                const esSpecific = (WHITE_LABEL as any).slideEmbedUrls_es?.[moduleId];
                            ...
                            // 3. EN Specific
                            const enSpecific = WHITE_LABEL.slideEmbedUrls[moduleId];
            ...
            {moduleData.quiz && (
                <div className="mt-24 mb-12">
                    ...
                    <QuizModule
                        quiz={Array.isArray(moduleData.quiz) ? { title: moduleData.title || "Module Quiz", questions: moduleData.quiz } : moduleData.quiz}
                        onComplete={(score) => {
