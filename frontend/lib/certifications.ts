...
export const certificationTracks: CertificationTrack[] = [
  {
    id: `${WHITE_LABEL.companyName.toLowerCase()}-certified-${WHITE_LABEL.industry.toLowerCase()}-rep`,
    title: `${WHITE_LABEL.companyName} Certified ${WHITE_LABEL.industry} Rep`,
    ...
    whyItMatters:
      `This flagship credential signals a rep can move from discovery to close using ${WHITE_LABEL.companyName} standards and compliance-safe communication.`,
    status: "in-progress",
    progress: 78,
  ...
  },
  {
    ...
    description: `Specialized credential for high-performance consultative questioning and ${WHITE_LABEL.industry.toLowerCase()} prospect qualification flow.`,
    whyItMatters:
    ...
    credentialId: `${WHITE_LABEL.companyName.substring(0, 2).toUpperCase()}-DM-2026-0302-014`,
    statusHistory: [
  ...
  },
  {
    ...
    description: `Program completion credential proving full execution of ${WHITE_LABEL.companyName}'s 7-day ramp framework.`,
    whyItMatters:
    ...
    credentialId: `${WHITE_LABEL.companyName.substring(0, 2).toUpperCase()}-7D-2026-0305-004`,
    statusHistory: [
...
export const loggedInCertificationId = `${WHITE_LABEL.companyName.toLowerCase()}-certified-${WHITE_LABEL.industry.toLowerCase()}-rep`
