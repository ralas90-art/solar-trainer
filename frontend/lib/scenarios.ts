...
export const SCENARIOS: Record<string, Scenario> = {
    "d2d_1": {
        ...
        description: `Homeowner claims ${INDUSTRY.toLowerCase()} is too expensive.`,
        difficulty: "Medium",
        opening_line: `${INDUSTRY} is too expensive. I'll pass.`,
        briefing: `Goal: Overcome the price objection.\n\nKey Concepts:\n1. ${INDUSTRY} is a bill swap, not an extra cost.\n2. Focus on ROI (Return on Investment).\n3. Compare the rising cost of utility power vs. fixed ${INDUSTRY.toLowerCase()} payments.\n\nTip: Ask them 'How much did you pay for power last month?' to anchor the cost.`,
    ...
    "bad_experience": {
        ...
        difficulty: "Medium",
        opening_line: `My neighbor got ${INDUSTRY.toLowerCase()} and his roof leaked and he's still paying an electric bill. I don't trust it.`,
    ...
    "guarded_gloria": {
        ...
        difficulty: "Medium",
        opening_line: `No offense, but you're the third ${INDUSTRY.toLowerCase()} guy this month. The last one lied about our savings. I'm not falling for it again.`,
    ...
    "friendly_frank": {
        ...
        difficulty: "Medium",
        opening_line: `Hey, come on in! Want some coffee? My wife makes great coffee. So you're the ${INDUSTRY.toLowerCase()} guy — my buddy Mike said you were coming. Tell me everything!`,
    ...
    [`${INDUSTRY.toLowerCase()}_sam`]: {
        id: `${INDUSTRY.toLowerCase()}_sam`,
        name: `${INDUSTRY} Sam`,
        description: `Day 3: Already has ${INDUSTRY.toLowerCase()}. Tests referral pivot and upsell.`,
        difficulty: "Medium",
        opening_line: `Oh yeah, we already went ${INDUSTRY.toLowerCase()} two years ago. The system's fine. Not sure why you're knocking.`,
        briefing: `Goal: Turn an existing ${INDUSTRY.toLowerCase()} customer into a referral or upsell opportunity.\n\nKey Concepts:\n1. Don't leave — warm lead for referrals and battery upsell.\n2. Check satisfaction, then referral ask.\n3. Orphan owner check: 'Is your original rep still around?'\n\nTip: Existing ${INDUSTRY.toLowerCase()} homes are the easiest referral sources if you lead with service.`,
    ...
    "hesitant_helen": {
        ...
        difficulty: "Hard",
        opening_line: `So I was really excited after our meeting, but then I talked to my sister and she said ${INDUSTRY.toLowerCase()} companies are all scams and I should wait for the technology to get better. Now I'm not sure.`,
    ...
    "rodriguez_family": {
        ...
        difficulty: "Expert",
        opening_line: `(Mr. Rodriguez) We got quotes from Tesla and Sunrun already. (Mrs. Rodriguez) And my mother says it's a scam. (Teenager walks in) Dad, the internet's out again — can ${INDUSTRY.toLowerCase()} fix that? (Dog barking in background)`,
