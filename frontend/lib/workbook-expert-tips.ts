...
export const EXPERT_PRO_TIPS: Record<string, string> = {
    ...
    "wb_1_4_1": `Leverage the Federal ITC (30%) as a core driver of urgency. Explain to homeowners that while the tax credit is secured through 2032, utility rate hikes are compounding annually—waiting a year is actually a net loss.`,
