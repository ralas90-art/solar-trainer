        ...
        <div className="min-h-screen bg-[#121212] text-white flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h1 className="font-display text-3xl font-black tracking-tight flex items-center justify-center gap-2">
                        ...
                        {WHITE_LABEL.isDemoMode && (
                            <span className="text-[10px] bg-[#FF5722]/20 text-[#FF5722] border border-[#FF5722]/30 px-2 py-0.5 rounded-full uppercase tracking-tighter">Demo</span>
                        )}
                    </h1>
                ...
                <p className="mt-8 text-center text-[#475569] text-[10px] font-hud uppercase tracking-widest">
                    Authorized Personnel Only // Global Training Network
                </p>
            </div>
        </div>
    )
