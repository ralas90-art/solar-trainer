  ...
  return (
    ...
    >
      <div className="space-y-8">
        {/* Unified Gamification Bar */}
        <div className="rounded-3xl border border-white/5 bg-black/40 p-1 backdrop-blur-xl">
          <GamificationBar 
            gamification={{
              totalXp: stats.totalXP,
              currentStreak: stats.streak,
              lastStreakDate: new Date().toISOString(),
              totalTrainingDays: 1, // Placeholder
              xpAwards: {},
              activityLog: []
            }} 
          />
        ...
        <div className="space-y-6">
          <section className="grid gap-6 xl:grid-cols-[1.6fr_1fr]">
            ...
            <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-1">
              <ProgressCard
                ...
                value={stats.todayChallengeScenarioId?.split("-").map(w => w.charAt(0).toUpperCase() + w.slice(1)).join(" ") || "Discovery Drills"}
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <Link href="/ai-simulator" className="block transition-transform hover:scale-[1.01]">
                  <div className="h-full rounded-2xl border border-white/5 bg-white/5 p-5">
                    ...
                    <p className="mt-2 text-sm text-[#CBD5E1]">
                      {Math.max(0, 2000 - (stats.totalXP % 2000))} XP until next milestone. Completing today&apos;s challenge and one simulator win clears it.
                    </p>
                    <div className="mt-4 h-2 overflow-hidden rounded-full bg-white/5">
                      <div className="brand-progress h-full" style={{ width: `${stats.levelProgress}%` }} />
                    </div>
                  </div>
                </Link>
              </div>
          ...
          <section className="grid gap-6 xl:grid-cols-3">
            ...
            <ModuleCard
              ...
              subtitle={`View your progress toward becoming a certified ${WHITE_LABEL.companyName} Closer.`}
              progress={stats.certificationProgress}
              badge="On track"
              href="/certifications"
            />
