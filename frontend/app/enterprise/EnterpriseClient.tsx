...
const enterpriseFeatures = [
  ...
  },
  {
    ...
    description: `Build bespoke training paths tailored to your specific ${WHITE_LABEL.industry.toLowerCase()} products.`,
    icon: Shield,
    color: "text-[#F59E0B]"
  },
  {
...
export default function EnterpriseClient() {
  ...
  useEffect(() => {
      if (tier === 'team') {
          setFormData(prev => ({ ...prev, teamSize: 20, useCase: "Interested in Team License" }))
      } else if (tier === 'enterprise') {
          setFormData(prev => ({ ...prev, teamSize: 100, useCase: "Interested in Enterprise Solution" }))
      }
  }, [tier])
    ...
    <div className="min-h-screen bg-[#121212] text-slate-100 font-body selection:bg-[#F97316]/30">
      ...
      <main className="relative max-w-7xl mx-auto px-6 py-24 md:py-32 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-12">
          <div className="space-y-6">
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9] font-display uppercase italic">
              Scale Your <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F97316] to-[#F59E0B]">{WHITE_LABEL.industry} Sales</span><br />
              Acceleration
            </h1>
            <p className="text-xl text-[#94A3B8] max-w-lg leading-relaxed font-light">
              Equip your entire organization with AI-driven training models designed for the high-stake {WHITE_LABEL.industry.toLowerCase()} industry.
            </p>
          </div>
        ...
        <div className="relative">
          {isSubmitted ? (
            <div className="relative bg-[#121212] border border-[#F59E0B]/30 p-12 rounded-[2.5rem] shadow-[0_0_30px_rgba(249,115,22,0.1)] text-center space-y-6">
            ...
            <>
              ...
              <div className="relative bg-[#121212] border border-white/10 p-8 md:p-12 rounded-[2.5rem] shadow-2xl space-y-8">
                <div className="text-center space-y-2">
                  <h2 className="text-3xl font-black tracking-tight font-display uppercase italic text-glow">Request Demo Access</h2>
                  <p className="text-[#64748B] text-[10px] font-black uppercase tracking-widest font-display">Connect with a {WHITE_LABEL.industry} Training Consultant</p>
                </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          placeholder={`john@${WHITE_LABEL.companyName.toLowerCase().replace(/\s+/g, '')}.com`}
                          className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-sm focus:border-[#F97316]/50 outline-none transition-all placeholder:text-slate-600"
                        />
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        placeholder={`Mega ${WHITE_LABEL.industry} Tech`}
                        className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-sm focus:border-[#F97316]/50 outline-none transition-all placeholder:text-slate-600"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-end">
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-black text-[#F97316] font-display italic leading-none">{formData.teamSize === 500 ? "500+" : formData.teamSize}</div>
                        <div className="text-[10px] font-black text-[#F59E0B] uppercase tracking-tighter mt-1">
                          {formData.teamSize < 15 ? "Recommended: Starter" : formData.teamSize <= 100 ? "Recommended: Growth" : "Recommended: Enterprise"}
                        </div>
                      </div>
                    </div>
                    <input 
      ...
      <footer className="max-w-7xl mx-auto px-6 py-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 opacity-40">
        <h1 className="font-display text-xl font-black tracking-tight flex items-center gap-2 uppercase italic">
          {WHITE_LABEL.companyName} <span className="text-[#F97316]">OS</span>
        </h1>
