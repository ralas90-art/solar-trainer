...
export default function PricingClient({}: PricingClientProps) {
    const [repCount, setRepCount] = useState(10)

    const tiers = [
        {
            name: "Starter",
            tagline: `Essential AI training for emerging ${WHITE_LABEL.industry.toLowerCase()} teams focused on fundamental closing.`,
            platformFee: 499,
            repFee: 39,
            ...
            features: [
                ...
                `Full ${WHITE_LABEL.industry.toLowerCase()} sales curriculum`,
                "Narrated lessons",
        ...
        {
            name: "Enterprise",
            tagline: `Private cloud infrastructure for Large Organizations and multi-state ${WHITE_LABEL.industry.toLowerCase()} companies.`,
            platformFee: "Custom",
            repFee: "Custom",
            ...
            href: "/enterprise?tier=enterprise"
        }
    ]
        ...
        <div className="min-h-screen bg-[#121212] text-slate-100 font-body selection:bg-[#F97316]/30">
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-20">
                ...
                <div className="mb-32 text-center">
                    <p className="text-slate-500 text-sm font-light font-body mb-8">
                        Looking for a custom team quote or white-label solution?
                    </p>
                    <div className="flex justify-center gap-6">
                        <Link href="/enterprise?tier=team" className="text-[#F97316] font-display text-[10px] font-black uppercase tracking-widest border-b border-[#F97316]/30 pb-1 hover:border-[#F97316] transition-all">
                            Request Team License
                        </Link>
                        <Link href="/solar-sales-training-assessment" className="text-[#F59E0B] font-display text-[10px] font-black uppercase tracking-widest border-b border-[#F59E0B]/30 pb-1 hover:border-[#F59E0B] transition-all">
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-slate-400 mb-10 font-body font-light leading-relaxed max-w-lg">
                                Our platform doesn't just train; it rewires the sales process. Reps utilizing {WHITE_LABEL.companyName} simulations consistently bridge the gap between amateur performance and mastery.
                            </p>
                            <div className="space-y-6">
                                ...
                                <div className="group">
                                    <div className="flex justify-between items-end mb-2">
                                        <span className="text-[10px] font-black uppercase tracking-widest text-[#F97316] font-display">{WHITE_LABEL.companyName} Mastery Path</span>
                ...
                <div className="mt-32 text-center">
                    <div className="max-w-3xl mx-auto glass-card p-16 hud-border hud-corner-tl hud-corner-tr hud-corner-bl hud-corner-br">
                        <h2 className="text-3xl lg:text-4xl font-black font-display tracking-tight uppercase italic mb-8">Ready for <span className="text-[#F97316]">Peak Performance?</span></h2>
                        <div className="flex flex-wrap justify-center gap-6">
                            <Link href="/signup">
                                <button className="btn-primary px-10 py-5 text-xs rounded-sm h-auto translate-y-0 text-white border-none">
                                    Initiate Organization Training
                                </button>
                            </Link>
                            <Link href="/enterprise?tier=enterprise">
