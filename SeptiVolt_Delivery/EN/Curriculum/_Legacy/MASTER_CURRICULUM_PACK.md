# SEPTIVOLT MASTER CURRICULUM PACK
This file contains the FULL content for all 7 days of training. Use this for Translation and Slide Generation.
...
- **ID:** mod_1_5a
- **Subtitle:** Master the mechanics of utility billing and NEM in simple language
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_1_5b
- **Subtitle:** Understanding Cash, Loans, Leases, and PPAs
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_3_7a
- **Subtitle:** Uncover hidden technical deal-killers through deep discovery
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_3_7b
- **Subtitle:** Closing the gap between sales and installation
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_4_1a
- **Subtitle:** The anatomy of a winning solar presentation
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_4_2a
- **Subtitle:** How to explain high-tech solar in low-tech language
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_4_2b
- **Subtitle:** How to win against 'The Other Guy' without being negative
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_5_5a
- **Subtitle:** High-momentum language for the final decision
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_5_5b
- **Subtitle:** Turn every customer into a lead generator
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_5_5c
- **Subtitle:** The 5-star experience after the signature
#### CONTENT SECTIONS
**Introduction**  
...
- **ID:** mod_5_5d
- **Subtitle:** Saving the deal when things change
#### CONTENT SECTIONS
**Introduction**  
